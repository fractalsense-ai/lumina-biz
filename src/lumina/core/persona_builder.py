...
_COMMAND_TRANSLATOR_FALLBACK: str = (
    ...
    "- role is REQUIRED — always a system role. If the user says 'subject', 'reviewer', etc., "
    ...
    "## Role mapping\n"
    "- Domain-specific roles (subject, reviewer, assistant, guardian, observer; "
    "legacy: student, teacher, teaching_assistant, parent; plus field_operator, "
    "site_manager) map to system role 'user'. Preserve the original name in an "
    "'intended_domain_role' param.\n"
    "- Valid system roles: root, super_admin, admin, operator, half_operator, user, guest.\n\n"
