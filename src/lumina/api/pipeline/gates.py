...
def check_user_freeze(
    ...
    return {
        "response": (
            "Your account is temporarily locked pending review by the assigned reviewer. "
...
def check_session_freeze(
    ...
    return {
        "response": "This session is temporarily locked pending review by the assigned reviewer.",
