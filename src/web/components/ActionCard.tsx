...
export function ActionCard({ card, token, userRole, onResolved }: ActionCardProps) {
  ...
  // Subjects and other non-governance roles see the card as read-only.
  const GOVERNANCE_ROLES = ['root', 'admin', 'super_admin', 'operator', 'half_operator', 'reviewer', 'teacher']
