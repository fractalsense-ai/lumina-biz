...
**Depends on:** [turn-interpretation-spec-v1](../../model-packs/business-ops/domain-lib/reference/turn-interpretation-spec-v1.md), [nlp-semantic-router](nlp-semantic-router.md)
...
2. Providing a `multi_task_interpretation_prompt_path` in the `runtime:` section:
   ...
   ```yaml
   runtime:
     multi_task_interpretation_prompt_path: model-packs/business-ops/domain-lib/reference/turn-interpretation-spec-v1.md
   ```
