...
| [nlp-pre-interpreter](nlp-pre-interpreter.md) | Deterministic NLP pre-interpreter for student messages (business-ops domain) |
| [fluency-monitor](fluency-monitor.md) | Consecutive-success fluency gate for tier advancement (business-ops domain) |
| [problem-generator](problem-generator.md) | Tier-based algebra problem generator (business-ops domain) |
